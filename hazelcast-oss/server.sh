...
export CLASSPATH=$HAZELCAST_HOME/hazelcast-aws-2.1.1-SNAPSHOT.jar:$HAZELCAST_HOME/hazelcast-all-$HZ_VERSION.jar:$HAZELCAST_HOME/cache-api-1.0.0.jar:$CLASSPATH/*
